...
RENDER(PlayerCave, {
	...
	// mov [p1base+eax],esi
	a.mov(x86::ptr(x86::eax, remoteAddr + OFFSETOF(player_bases[0]), sizeof(void*)), x86::esi);

	// mov ebx,[esi+14]
	a.mov(x86::ebx, x86::ptr(x86::esi, 0x14));

	// mov [p1coords+eax],ebx
	a.mov(x86::ptr(x86::eax, remoteAddr + OFFSETOF(player_coords[0]), sizeof(void*)), x86::ebx);
