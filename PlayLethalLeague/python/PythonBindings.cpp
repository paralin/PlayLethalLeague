...
BOOST_PYTHON_MODULE(LethalLeague)
{
	...
	class_<Game>("Game", no_init)
		...
		.def("setBallXCoord", &Game::setBallXCoord)
		.def("setBallYCoord", &Game::setBallYCoord)
		.def("setPlayerXCoord", &Game::setPlayerXCoord)
		.def("setPlayerYCoord", &Game::setPlayerYCoord)
		.def("setBallState", &Game::setBallState)
		.def("setBallRespawnTimer", &Game::setBallRespawnTimer)
